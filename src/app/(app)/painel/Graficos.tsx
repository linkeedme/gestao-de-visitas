/**
 * Os dois gráficos da tela de gestão.
 *
 * Já estiveram aqui, saíram e voltaram — vale registrar por quê, para ninguém
 * refazer a viagem. Saíram junto com um gráfico de barras por pessoa, e o
 * argumento era certo para aquele: somar a equipe apagava a pergunta de quem
 * fez o quê, que a tabela por pessoa responde melhor. O argumento foi aplicado
 * demais, e levou junto estes dois, que não somam pessoas — somam tempo e
 * motivo.
 *
 * Movimento por dia mostra ritmo: buraco no meio da semana, pico no fim do
 * mês, o dia em que ninguém saiu. Por tipo mostra a composição do trabalho —
 * um time que só faz manutenção e nunca prospecta parece ocupado nos números
 * e está encolhendo a carteira.
 */

      ...
      <form method="get" action="/painel" className="flex flex-wrap items-end gap-2">
        <label className="flex min-w-0 flex-1 flex-col gap-1">
          ...
          <input
            ...
            name="de"
            defaultValue={de}
            className="min-h-11 rounded-xl bg-slate-50 px-3 text-sm ring-1 ring-slate-200"
          />
        </label>
        <label className="flex min-w-0 flex-1 flex-col gap-1">
        ...
        <button
          type="submit"
          className="min-h-11 rounded-xl bg-asfalto px-4 text-sm font-semibold text-white"
        >
          Aplicar
        </button>
      </form>
